...
export const ADMIN_NAV_ITEMS = [
  ...
  // Scheme System — Schemes + Enrollments + Collections live under the
  // collapsible "Scheme" section (consecutive same-group items). Payments is a
  // separate top-level item, NOT nested under Scheme. Each keeps its own real
  // route so StaffAccessGuard's path-prefix match is unaffected. Scheme
  // Requests was removed per requirements.
